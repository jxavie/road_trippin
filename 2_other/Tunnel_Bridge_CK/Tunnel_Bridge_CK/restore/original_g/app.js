...
var us_map = L.map('map').setView([41.320961, -104.052476], 4);
...
var mapbox = L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}", {
    ...
    maxZoom: 16,
    id: "mapbox.dark",
    accessToken: "sk.eyJ1IjoiYmFkY2hhaSIsImEiOiJjazVpeXl6dWowMTg1M2ZwN2E2Z2NsajBsIn0.ODWJyPUL8ZCYxo-fWYI6Nw"
}).addTo(us_map);
    ...
    us_geojson = L.choropleth(data, {
        ...
        onEachFeature: function (feature, layer) {
            var popupString = `<div class="card">
                <div class="card-header"><h3>${data[0].feature.properties.NAME}</h3></div>
                <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    <p>Total Amount</p><p>Amount good</p><p>Amount fair</p> <p>Amount Poor</p>
                    </div>
                    <div class="col-md-6">
    ...
    tunnel_layer = L.choropleth(data, {
        ...
        onEachFeature: function (feature, layer) {
            var popupString = `<div class="card">
                ...
                <div class="row">
                    <div class="col-md-6">
                    <p>Total Amount</p><p>Amount good</p><p>Amount fair</p> <p>Amount Poor</p> <p>Amount Severe</p>
                    </div>
                    <div class="col-md-6">
